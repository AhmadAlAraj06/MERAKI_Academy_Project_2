...
$(document).ready(function(){
  ...
  $("#needsfeedbackkkk").click(function(){
...
//   });
//   $("#needstoffi").click(function(){
    
//     $("#toffiproduct").hide();
//     $("#snackcandy").show();
//   });
//   $(".toblee").click(function(){
    
//     $("#snackcandy").hide();
//     $("#tableproduct").show();
    
//   });
//   $("#needstoble").click(function(){
    
//     $("#tableproduct").hide();
//     $("#snackcandy").show();
//   });
//   $(".bready").click(function(){
    
//     $("#snackcandy").hide();
//     $("#bready").show();
    
//   });
//   $("#needsready").click(function(){
    
//     $("#bready").hide();
//     $("#snackcandy").show();
//   });
//   $(".skitttr").click(function(){
    
//     $("#snackcandy").hide();
//     $("#skittlesss").show();
    
//   });
//   $("#needsskit").click(function(){
    
//     $("#skittlesss").hide();
//     $("#snackcandy").show();
//   });
//   $(".mennn").click(function(){
    
//     $("#snackcandy").hide();
//     $("#mennntt").show();
    
//   });
//   $("#needsment").click(function(){
    
//     $("#mennntt").hide();
//     $("#snackcandy").show();
//   });
//   $(".poppp").click(function(){
    
//     $("#snackcandy").hide();
//     $("#poppppp").show();
    
//   });
//   $("#needspopcornnn").click(function(){
...
//   });
//   $("#needsbrbrb").click(function(){
    
//     $("#brrrrrrr").hide();
//     $("#breadindex").show();
//   });
//   $(".tommm").click(function(){
    
//     $("#vegetabless").hide();
//     $("#tommmm").show();
    
//   });
//   $("#needstomoyy").click(function(){
    
//     $("#tommmm").hide();
//     $("#vegetabless").show();
//   });
//   $(".egggg").click(function(){
    
//     $("#Dairyeggs").hide();
//     $("#eggggggg").show();
    
//   });
//   $("#needssssss").click(function(){
...
//   });
//   $("#needsaaaaa").click(function(){
    
//     $("#aaaaaaaaaaa").hide();
//     $("#Deli").show();
//   });
//   $(".alammama").click(function(){
    
//     $("#milkn").hide();
//     $("#alammamascd").show();
    
//   });
//   $("#needsallalal").click(function(){
    
//     $("#alammamascd").hide();
//     $("#milkn").show();
//   });
//   $(".bbbbbbb").click(function(){
    
//     $("#frooozen").hide();
//     $("#dsvfzx").show();
    
//   });
//   $("#needsdfrdgfbd").click(function(){
...
//   });
//   $("#needsbbrrrrr").click(function(){
    
//     $("#fgfgsrgf").hide();
//     $("#breakfastc").show();
//   });
//   $(".cofffff").click(function(){
    
//     $("#coffetea").hide();
//     $("#fgdvngggg").show();
    
//   });
//   $("#needsccccc").click(function(){
    
//     $("#fgdvngggg").hide();
//     $("#coffetea").show();
//   });
//   $(".mmmmmm").click(function(){
    
//     $("#icecreamma").hide();
//     $("#mhmgmhgmm").show();
    
//   });
//   $("#needsmmmm").click(function(){
    
//     $("#mhmgmhgmm").hide();
//     $("#icecreamma").show();
//   });
//   $(".tangggggg").click(function(){
    
//     $("#drinke").hide();
//     $("#tannnnng").show();
    
//   });
//   $("#needsdfjifd").click(function(){
    
//     $("#tannnnng").hide();
//     $("#drinke").show();
//   });
// $(".wwwwwwwwwater").click(function(){
    
//   $("#waterpr").hide();
//   $("#nnnne").show();
  
// });
// $("#needswwwwwwaa").click(function(){
  
//   $("#nnnne").hide();
//   $("#waterpr").show();
// });
// $(".ritter").click(function(){
    
//   $("#snackcandy").hide();
//   $("#ritrrr").show();
  
// });
// $("#needsrittrr").click(function(){
...
// });
// $("#needsnnnuutt").click(function(){
  
//   $("#gonut").hide();
//   $("#snackcandy").show();
// });
// $(".nnnoo1").click(function(){
    
//   $("#snackcandy").hide();
//   $("#nn11oo").show();
  
// });
// $("#needsnnnnnoo").click(function(){
